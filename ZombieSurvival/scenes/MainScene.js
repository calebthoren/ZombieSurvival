export default class MainScene extends Phaser.Scene {
    ...
    preload() {
        // Load player, zombie, and rock images
        this.load.image('player', 'https://labs.phaser.io/assets/sprites/phaser-dude.png');
        this.load.image('zombie', 'assets/zombie_scaled.png');
    ...
    create() {
        ...
        this.ammoText.setScrollFactor(0); // stay fixed on screen
    ...
    update() {
        ...
        this.zombies.getChildren().forEach(zombie => {
            ...
            // Determine direction the zombie is moving
    ...
    handlePlayerZombieCollision(player, zombie) {
        // Game over when player is touched by a zombie
        if (this.isGameOver) return;

        this.isGameOver = true;
        this.physics.pause(); // Freeze all physics
        player.setTint(0x720c0c); // Tint player red
        ...
        // Add dark red outline to the text
